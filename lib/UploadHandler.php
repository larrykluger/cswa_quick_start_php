 ...
 *
 * Modified by Larry per
 * https://github.com/blueimp/jQuery-File-Upload/wiki/How-to-submit-additional-form-data-and-save-to-database
 * to save the file as "u_<uid>_<filename.pdf>" where u means unsigned and uid is exactly 36 characters wide
 *
 */
...
class UploadHandler
{
    ...
    function __construct($options = null, $initialize = true, $error_messages = null) {
        $this->options = array(
            ...
            //'accept_file_types' => '/.+$/i',
            'accept_file_types' => '/\.(pdf|doc|xls|docx|xlsx)$/i',
    ...
    protected function handle_form_uid($file, $index) {
        // Handle form data, e.g. $_REQUEST['description'][$index]
        $uid = $_REQUEST['uid'];
        return $uid;
    }
    ...
    protected function handle_file_upload($uploaded_file, $name, $size, $type, $error,
        ...
        if ($this->validate($uploaded_file, $file, $error, $index)) {
			...
			// change file name to be u_<uid>_<filename.pdf>"
			$file->name = "u_" . $this->handle_form_uid($file, $index) . "_" . $file->name;
